...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="user/dist/img/hostel-animate.png" alt="Hostel Users" height="60" width="60">
    </div>
...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="hostel_booking" class="nav-link">Book</a>
        </li>
    </ul>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/home" class="brand-link">
        <img src="user/dist/img/logo.png" alt="User Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">User Logo</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="/all_rules" class="nav-link">
...
<div class="content-wrapper">
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2022/2023 <a href="#">User Dashboard</a>.</strong>
        All rights reserved.
        <div class="float-right d-none d-sm-inline-block">
            <b>Welcome to our hostels</b>
        </div>
    </footer>
    <!-- Control Sidebar -->
